...
int main() {
    ...
    ofstream fileOut("codificadok4.bin", ios::binary);
    ...
    vector<unique_ptr<ArvHuffman>> k1, k2, k3, k4;
    string textoCod;

    string charPrev, charPrev2, charPrev3, charPrev4;
    ...
    cout << "Tempo de execução para K = 4: " << duracao.count() << " segundos" << endl;

    float nSimb = TextProcessing::countTotalChar();
    float bitspSimb = textoCod.size()/nSimb;

    cout << "Comprimido em K = 4 com " << bitspSimb << " bits/símbolo." << endl;
